...
<?PHP
include_once "C:/xampp/htdocs/pro.k/core/pack_bd.php";
...
require_once "C:/xampp/htdocs/pro.k/core/promo_bd.php";
           ...
           /* if ($result11 !== false) */{
            ...
            $p=$result11['prix']-($promotion['pourcentage']*$result11['prix']/100)
                  ...
                  <tr>   
                    ...
                    <td><img src="/promo/assets1/img/<?PHP echo $result11['image']; ?>"></td>
