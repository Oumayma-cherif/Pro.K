            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li  >
                        <a  href="promo.html"><i class="fa fa-table fa-3x"></i> promo</a>
                    </li>
                    <li  >
                     ...
                     <h2>pack Page</h2>   
                        ...
                        <div class="container-contact100">
                            <div class="wrap-contact100">
                                <form class="contact100-form validate-form"  method="POST" action="ajouterpack.php" >
                                    ...
                                    <div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
                                        ...
                                        <input  class="input100" type="text" name="ReferencePack" placeholder="Enter Your Name">
                                    </div>
                    
                                    <div class="wrap-input100 validate-input bg1 " >
                                        <span class="label-input100">identifiant pack</span>
                                        <input id="identifiantpack" class="input100" type="text" name="identifiantpack" placeholder="Enter product ">
                                    </div>
                    
                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                        <span class="label-input100">Date debut pack</span>
                                        <input  class="input100" type="date" name="Datedebutpack" >
                                    </div>
                                    <div class="wrap-input100 bg1 rs1-wrap-input100">
                                        <span class="label-input100">Date fin pack</span>
                                        <input  class="input100" type="date" name="Datefinpack" >
                                    </div>
                                   <div class="wrap-input100 bg1 rs1-wrap-input100">
                        ...
                        <a href="affichage2.php"> Afficher les pack </a>
