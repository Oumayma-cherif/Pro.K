...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
   ...
   <table class="content-table">
               ...
               foreach($listpromotion as $row){
                   ...
                   <td><a href="modifierpromotion.php?id=<?php echo $row['id'];  ?>"> Modifier</a></td>
                   <td><a href="supprimerpromotion.php?id=<?php echo $row['id'];  ?>">Supprimer</a></td>
                   </tr>
               ...
               <a href="promo.php"> Ajouter une nouveau promotion </a>
               <a href="reporte.php"> pdf promotion </a>
